...
class TestData(unittest.TestCase):
    ...
    def test_calendar(self):
        # call
        _df = pn.opt.spread.calendar(self.optdata, 'call', 10., '2015-05-01', '2015-06-01')
        ...
        self.assertAlmostEqual(_df.loc['Underlying', 'Value'], 10.1)
        self.assertEqual(_df.loc['Quote_Time', 'Value'], dt.datetime(2015, 3, 1))
        # put
        _df = pn.opt.spread.calendar(self.optdata, 'put', 10, '2015-05-01', '2015-07-01')
        self.assertAlmostEqual(_df.loc['Near', 'Value'], .9)
        self.assertAlmostEqual(_df.loc['Far', 'Value'], 1.1)
        self.assertAlmostEqual(_df.loc['Debit', 'Value'], .2)
        self.assertAlmostEqual(_df.loc['Underlying', 'Value'], 10.1)
        # exceptions
        self.assertRaises(KeyError, pn.opt.spread.calendar, self.optdata, 'call', 
                11, '2015-05-01', '2015-07-01')
        self.assertRaises(KeyError, pn.opt.spread.calendar, self.optdata, 'call', 
                10., '2015-05-02', '2015-07-01')

    def test_dblcal(self):
        _df = pn.opt.spread.dblcal(self.optdata, 8., 12., '2015-05-01', '2015-07-01')
        # calls
        ...
        self.assertEqual(_df.loc['Quote_Time', 'Value'], dt.datetime(2015, 3, 1))
        # exceptions
        self.assertRaises(KeyError, pn.opt.spread.dblcal, self.optdata, 8., 11.9,
                '2015-05-01', '2015-07-01')
        self.assertRaises(KeyError, pn.opt.spread.dblcal, self.optdata, 10., 12.,
                '2015-05-01', '2015-06-15')

    def test_diagbtrfly(self):
        _df = pn.opt.spread.diagbtrfly(self.optdata, 8., 10., 12., '2015-06-01', '2015-07-01')
        # near
        ...
        self.assertEqual(_df.loc['Quote_Time', 'Value'], dt.datetime(2015, 3, 1))
        #exceptions
        self.assertRaises(KeyError, pn.opt.spread.diagbtrfly, self.optdata, 8., 10., 11.9, 
                '2015-06-01', '2015-07-01')
        self.assertRaises(KeyError, pn.opt.spread.diagbtrfly, self.optdata, 8., 10., 12., 
                '2015-06-11', '2015-07-01')

    def test_straddle(self):
        _df = pn.opt.spread.straddle(self.optdata, 10., '2015-06-01')
        ...
        self.assertAlmostEqual(_df.loc['Underlying', 'Value'], 10.1)
        self.assertEqual(_df.loc['Quote_Time', 'Value'], dt.datetime(2015, 3, 1))
        self.assertRaises(KeyError, pn.opt.spread.straddle, self.optdata, 9.9, '2015-06-01')
